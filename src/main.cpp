...
float vertices[] = {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        lightObjectShader.setVec3("u_Light.diffuse", glm::vec3(1.0f, 1.0f, 1.0f)); // change to diffuse color to get randomized color values based on the color of the light source.
