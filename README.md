...
| `T` (press)| Toggles draw calls using either instanced or non-instanced element arrays. Relevant debug log is printed to display the time it takes for each render process to finish.|
